...
public:
	...
	//virtual void	CreateDuplicateForm() override;
	//virtual void	CheckSaveGame() override;
	//virtual void	SaveGame() override;
	//virtual void	LoadGame() override;
	//virtual void	InitLoadGame() override;
	//virtual void	FinishLoadGame() override;
	//virtual void	Revert() override;
	//virtual void	InitItemImpl() override;
	//virtual void	GetSavedFormType() override;
	//virtual void	GetFormDetailedString() override;
	//virtual void	GetRandomAnim() override;
	//virtual void	GetDangerous() override;
	//virtual void	GetObstacle() override;
	//virtual void	GetOnLocalMap() override;
	//virtual void	GetMustUpdate() override;
	//virtual void	SetOnLocalMap() override;
	//virtual void	GetIgnoredBySandbox() override;
	//virtual void	SetDelete() override;
	//virtual void	SetAltered() override;
	//virtual void	IsWater() override;
	//virtual void	IsReference() override;
	//virtual void	IsReference() override;
	//virtual void	BelongsInGroup() override;
	//virtual void	CreateGroupData() override;
...
public:
	...
	DEFINE_MEMBER_FN(GetCurrent3D, NiAVObject*, 0x00E9FED0);
	DEFINE_MEMBER_FN(Get3D, NiAVObject*, 0x00E9FF10, bool);
