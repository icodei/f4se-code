...
extern "C" DLLEXPORT bool F4SEAPI F4SEPlugin_Load(const F4SE::LoadInterface* a_f4se) {
	...
	REL::Relocation<uintptr_t> PCUpdateMainThread{ REL::ID(633524), 0x22D };
	Info.PCUpdateMainThreadOrig = g_trampoline.write_call<5>(PCUpdateMainThread.address(), &PlayerUpdateHandler::HookedUpdate);

	HookInfo::HookDetours();
