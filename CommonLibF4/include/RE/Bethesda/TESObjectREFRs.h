...
namespace RE
{
	...
	{
	public:
		static constexpr auto RTTI{ RTTI::BSAnimationGraphManager };
		static constexpr auto VTABLE{ VTABLE::BSAnimationGraphManager };

		virtual ~BSAnimationGraphManager();
		virtual BSEventNotifyControl ProcessEvent(const BSAnimationGraphEvent& a_event, BSTEventSource<BSAnimationGraphEvent>* a_source) override = 0;

		//members
		std::uint32_t pad0C;
		BSTArray<void*> boundChannels;
		BSTArray<void*> bumpedChannels;
		BSTArray<void*> graphs;
		BSTArray<void*> subManagers;
		BSTArray<void*> field_70;
