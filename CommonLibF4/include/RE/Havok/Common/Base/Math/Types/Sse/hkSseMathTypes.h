...
#		define HK_QUADDOUBLE_CONSTANT(a, b, c, d) \
			{                                      \
				a, b, c, d                         \
			}
...
#		define HK_TRANSPOSE4d(v0, v1, v2, v3)                              \
			{                                                               \
				__m128d __t1, __t2;                                         \
				__t1 = v1.m_quad.xy;                                        \
...
// transpose 3 hkVector4: w component is undefined
#		define HK_TRANSPOSE3d(v0, v1, v2)                                  \
			{                                                               \
				__m128d __t1, __t2;                                         \
...
#	define HK_QUADFLOAT_CONSTANT(a, b, c, d) \
		{                                     \
			a, b, c, d                        \
		}
...
#	define HK_QUADINT_CONSTANT(a, b, c, d) \
		{                                   \
			a, b, c, d                      \
		}
...
#	if defined(HK_COMPILER_GCC) || defined(HK_COMPILER_CLANG) || (defined(_MSC_VER) && (_MSC_VER < 1500))  // vs 2005 is missing these
	...
	{
		hkQuadRealUnionM128(__m128 v) :
			m128_vecf(v) {}
		hkQuadRealUnionM128(__m128i v) :
			m128_veci(v) {}
		hkQuadRealUnionM128(__m128d v) :
			m128_vecd(v) {}
		__m128 m128_vecf;
		__m128i m128_veci;
		__m128d m128_vecd;
...
#		if defined(HK_COMPILER_GCC) || defined(HK_COMPILER_CLANG)
	...
	template <typename T>
	HK_FORCE_INLINE const hkQuadRealUnionM128& HK_M128(const T& t)
	{
		return reinterpret_cast<const hkQuadRealUnionM128&>(t);
	}
	template <typename T>
	HK_FORCE_INLINE hkQuadRealUnionM128& HK_M128(T& t)
	{
		return reinterpret_cast<hkQuadRealUnionM128&>(t);
	}
