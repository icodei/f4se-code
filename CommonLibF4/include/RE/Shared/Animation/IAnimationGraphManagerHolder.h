...
namespace RE
{
	...
	public:
		...
		virtual bool GetGraphVariableFloatByID([[maybe_unused]] std::uint32_t a_graphVarID, [[maybe_unused]] float& a_out) const { return false; }                                                                                   // 10
		virtual bool GetGraphVariableBoolByID([[maybe_unused]] std::uint32_t a_graphVarID, [[maybe_unused]] bool& a_out) const { return false; }                                                                                         // 11
		virtual bool GetGraphVariableIntByID([[maybe_unused]] std::uint32_t a_graphVarID, [[maybe_unused]] std::int32_t& a_out) const { return false; }                                                                                 // 12
		virtual bool GetGraphVariableFloatByName([[maybe_unused]] const BSFixedString& a_variable, [[maybe_unused]] float& a_out) const { return false; }                                                                                   // 13
		virtual bool GetGraphVariableIntByName([[maybe_unused]] const BSFixedString& a_variable, [[maybe_unused]] std::int32_t& a_out) const { return false; }                                                                            // 14
		virtual bool GetGraphVariableBoolByName([[maybe_unused]] const BSFixedString& a_variable, [[maybe_unused]] bool& a_out) const { return false; }                                                                                    // 15
