...
bool ScopeCamera::QCameraEquals(UInt32 cameraIndex)
{
	return false;
}

TESCameraState* ScopeCamera::QCameraState(UInt32 index)
{
	return nullptr;
}
...
ScopeCamera::ThermalState::ThermalState(TESCamera& cam, UInt32 ID) : DefaultState(cam, ID) {
...
ScopeCamera::NightVisionState::NightVisionState(TESCamera& cam, UInt32 ID) : DefaultState(cam, ID) {
